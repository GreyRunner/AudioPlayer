...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_MUSIC_LIST_CONTENT = "create table musicDetail(listId INTEGER,musicId INTEGER, musicName TEXT,artistName TEXT,albumName TEXT,duration INTEGER)";
    ...
    public static final String DELETE_FROM_MUSIC_DETAIL_ONE = "delete from musicDetail where musicId = ? and listId = ? ";
